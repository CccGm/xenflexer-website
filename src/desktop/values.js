...
export const Values = () => {
  return (
    <div className="px-6 py-16 md:p-20">
      <div className="grid grid-flow-row text-center justify-center gap-2">
      ...
      <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-40">
      ...
      <div className="mt-8 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 px-40">
        <div className="grid grid-flow-row justify-center text-center ">
          <div className="flex justify-center">
